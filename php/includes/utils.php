...
// When an avatar is created it stores the image path as an attribute
// when the functino save gets invoked -->  Avatar opens the file and writes the contents 
// of the tmp file into it.
